    ...
    <div className="min-h-screen bg-gradient-to-r from-[#fce8ec] to-[#f9f9f9] font-montserrat px-6 py-12">
      ...
      >
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Discover our graduate programs, research opportunities, and become a part of academic excellence.
        </motion.p>
        ...
        >
          <div>
            <h2 className="text-2xl font-semibold text-[#880C24] mb-4">Eligibility Criteria</h2>
            <ul className="list-disc list-inside text-gray-600 space-y-2">
              <li>Minimum 16 years of education (BS or equivalent).</li>
              <li>Minimum CGPA of 2.5 or 60% marks.</li>
              <li>Pass departmental test/interview.</li>
            </ul>
          </div>
          <div>
            <h2 className="text-2xl font-semibold text-[#880C24] mb-4">Required Documents</h2>
            <ul className="list-disc list-inside text-gray-600 space-y-2">
              <li>BS Degree & Transcript</li>
              <li>CNIC / B-Form</li>
              <li>Domicile</li>
